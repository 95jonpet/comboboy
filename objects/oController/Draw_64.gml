...
if (phase == phases.game_over) {
    ...
    draw_text(window_get_width() / 2, window_get_height() * 1/5 + 32, "GAME OVER")
    draw_set_valign(fa_bottom)
    draw_set_font(fnSubtitle)
    draw_text(window_get_width() / 2, window_get_height() * 2/5 - 32, "Comboboy " + gameOverReason)
    draw_text(window_get_width() / 2, window_get_height() * 4/5, "[CLICK] to retry")
